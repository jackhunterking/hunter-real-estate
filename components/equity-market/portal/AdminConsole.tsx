 ...
 *
 * Sections are declared once in lib/equity-market/admin-sections.ts; this component
...
import type { LearningAdminResource } from "@/lib/equity-market/learning";
import type { OfferingAdminRow } from "@/lib/equity-market/offering-admin-server";
import type { AdminDirectories } from "@/lib/equity-market/admin-server";
import {
  ADMIN_SECTIONS, ADMIN_SECTION_GROUPS, adminSection,
  type AdminSectionId,
} from "@/lib/equity-market/admin-sections";
