...
import {
  ...
  PrimaryAmountField,
  ToolHeader,
} from "@/components/equity-market/portal/CompareUI";
...
export function CompareInvestments({ funds }: { funds: FundComparable[] }) {
  ...
  function reset() {
    ...
    posthog?.capture("em_compare_reset", { language: lang });
  }
            ...
            <div className="grid gap-px bg-[#e6ebee] md:grid-cols-2">
              ...
              <section className="flex flex-col bg-white px-5 py-5">
                ...
                <div className="mt-auto flex justify-end pt-4">
                  <Link href={`${INVESTMENT_BASE_PATH}/investments/${fund.slug}`} className="inline-flex items-center gap-1 text-[11px] font-semibold text-[#0a4b72]">
                    {c.viewFund}
