...
import { buildFootprintGallery } from "@/lib/equity-market/landing-gallery";
...
export { tightRange as shortRange } from "@/components/equity-market/OfferingSummaryCard";

/** A photo shown in the real-assets footprint, with an honest caption. */
export type { FootprintImage } from "@/lib/equity-market/landing-gallery";
