...
const COPY = {
  tr: {
    ...
    title: "Equity Market ayrı bir platformdur.",
    body: "Jack Hunter sitesi gayrimenkul ve mortgage danışmanlığına odaklanır. Kanada’daki özel gayrimenkul ve alternatif yatırım fırsatlarına ilişkin araştırma, hesap ve ilgi kayıtları kontrollü Equity Market ortamında sunulur.",
    ...
    continue: "Equity Market’e devam et",
  ...
  en: {
    ...
    title: "Equity Market is a separate platform.",
    body: "The Jack Hunter site focuses on real estate and mortgage guidance. Research, accounts, and interest records for Canadian private real estate and alternative investment opportunities are provided in the controlled Equity Market environment.",
    ...
    continue: "Continue to Equity Market",
