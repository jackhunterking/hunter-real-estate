...
const COPY = {
  tr: {
    ...
    title: "Hunter & Hunter Yatırım Danışmanlığı ayrı bir platformdur.",
    body: "Jack Hunter sitesi gayrimenkul ve mortgage danışmanlığına odaklanır. Kanada’daki özel gayrimenkul ve alternatif yatırım fırsatlarına ilişkin araştırma, hesap ve ilgi kayıtları kontrollü Hunter & Hunter Yatırım Danışmanlığı ortamında sunulur.",
    ...
    continue: "Hunter & Hunter Yatırım Danışmanlığı’na devam et",
  ...
  en: {
    ...
    title: "Hunter & Hunter Investment Advisory is a separate platform.",
    body: "The Jack Hunter site focuses on real estate and mortgage guidance. Research, accounts, and interest records for Canadian private real estate and alternative investment opportunities are provided in the controlled Hunter & Hunter Investment Advisory environment.",
    ...
    continue: "Continue to Hunter & Hunter Investment Advisory",
