...
const COPY = {
  tr: {
    ...
    description:
      "SPL lisansına sahip ve SPK yetkili bir firmayla ilişkili profesyoneller Hunter & Hunter Yatırım Danışmanlığı erişimine başvurabilir.",
    modalDescription:
      "SPL sicilinizdeki bilgileri ve mevcut firma bağlantınızı girin. Hunter & Hunter Yatırım Danışmanlığı bilgileri resmi kaynaklardan doğrular.",
    ...
    consentLookup: "Hunter & Hunter Yatırım Danışmanlığı’nın resmi SPL araması yapmasına ve sonucu kaydetmesine izin veriyorum.",
    ...
    stateCopy: {
      not_applied: "Lisans ve firma bilgileriniz Hunter & Hunter Yatırım Danışmanlığı tarafından incelenir.",
      ...
      inactive: "Profesyonel erişiminizin yeniden etkinleştirilmesi için Hunter & Hunter Yatırım Danışmanlığı incelemesi gerekiyor.",
    },
  },
  en: {
    ...
    description:
      "Professionals with an SPL licence and an association with an SPK-authorized firm can apply for Hunter & Hunter Investment Advisory access.",
    modalDescription:
      "Enter the information shown in your SPL registry and your current firm association. Hunter & Hunter Investment Advisory verifies the details through official sources.",
    ...
    consentLookup: "I authorize Hunter & Hunter Investment Advisory to perform and record an official public SPL lookup.",
    ...
    stateCopy: {
      not_applied: "Hunter & Hunter Investment Advisory reviews your licence and firm information.",
      ...
      inactive: "Hunter & Hunter Investment Advisory review is required to restore your Professional access.",
    },
  },
} as const;
