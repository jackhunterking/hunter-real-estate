...
- `/equity-market` — canonical Equity Market public and portal path, implemented by `app/[locale]/equity-market/`
...
6. **Keep Equity Market’s role precise.** Public copy may describe Canadian private-real-estate and alternative-investment research, education, interest records, and licensed-process coordination. Do not imply that Equity Market itself provides portfolio management, securities execution, suitability approval, or regulated investment advice.
