...
- `/hunter-advisory` — canonical Hunter Advisory public and portal path; the `app/hunter-north-capital/` directory remains the internal implementation path for migration compatibility
...
6. **Keep Hunter Advisory’s role precise.** Public copy may describe Canadian private-real-estate and alternative-investment research, education, interest records, and licensed-process coordination. Do not imply that Hunter Advisory itself provides portfolio management, securities execution, suitability approval, or regulated investment advice.
