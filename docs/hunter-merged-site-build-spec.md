...
- **Hunter & Hunter Investment Advisory is consolidated** as the canonical Capital experience at `/hunter-group-capital`; legacy `/hunter-x-capital` URLs redirect there.
...
**Current nav:** Hakkımızda · Hizmetler · Hunter & Hunter Investment Advisory · Rehberler · İletişim
...
- **Investor content stays on its own page.** Hunter & Hunter Investment Advisory "raise/partner" language lives only on its section, away from the consumer mortgage funnel (different regime again).
