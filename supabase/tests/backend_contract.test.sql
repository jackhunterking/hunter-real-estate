...
select has_table('app', 'learning_resources', 'learning resources table exists');
select has_table('app', 'learning_resource_versions', 'learning resource versions table exists');
select has_table('app', 'learning_resource_sources', 'learning resource sources table exists');
select has_table('app', 'referral_qualification_assessments', 'referral qualification history exists');
...
select has_view('api', 'published_learning_resources', 'published learning API exists');
select has_view('api', 'learning_resource_admin', 'learning administration API exists');
select has_view('api', 'referral_qualification_assessments', 'qualification history API exists');
...
select has_function('api', 'create_learning_resource', array['jsonb'], 'learning draft transaction exists');
select has_function('api', 'update_learning_resource_draft', array['uuid','uuid','jsonb'], 'learning draft update exists');
select has_function('api', 'transition_learning_resource', array['uuid','uuid','text','text'], 'learning workflow transition exists');
select has_function('api', 'create_referral_qualification_assessment', array['uuid','jsonb'], 'qualification append transaction exists');
