...
function Readiness({ offering, c }: { offering: OfferingBundle; c: Copy }) {
  ...
  const category = useMemo(() => classifyOntario({ accreditedIncome: checks[0], accreditedFinancialAssets: checks[1], accreditedNetAssets: checks[2], eligibleIncome: checks[3], eligibleNetAssets: checks[4] }), [checks]);
