...
export const INVESTMENT_BRAND = {
  en: {
    ...
    // The wordmark is the name alone; no descriptor line sits under it.
    descriptor: "",
    ...
    legalParagraphs: [
      "Equity Market is Jack Hunter’s Parvis-approved marketing and trade name. It provides investment education, opportunity information, account access, preliminary tools, and investor-relationship support.",
  ...
  tr: {
    ...
    legalParagraphs: [
      "Equity Market, Jack Hunter’ın Parvis tarafından onaylanan tanıtım ve ticari markasıdır. Yatırım eğitimi, fırsat bilgileri, hesap erişimi, ön değerlendirme araçları ve yatırımcı ilişkileri desteği sunar.",
    ...
    disclosuresLink: "Kayıt ve açıklamalar",
